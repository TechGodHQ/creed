...
Define how Creed maps canonical source context into target-specific output files using semantic target output descriptors instead of relying on bare path order.
